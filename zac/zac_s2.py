...
from zac.s2_preprocessing import s2_pre_processing
...
def zac_s2(s2_t, send_back = False, mcd43 = home + '/MCD43/', vrt_dir = home + '/MCD43_VRT/', aoi = None, 
...
def exe():
    ...
    zac_s2(s2_t=args.file_path, mcd43=args.MCD43_file_dir, vrt_dir=args.vrt_dir, aoi=args.aoi)
